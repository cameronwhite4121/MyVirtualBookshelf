...
public partial class BookshelfPage : ContentPage
{
    ...
    /// </summary>
    public MainPage MainPageToUpdate { get; set; }

    public BookshelfPage(int sid, MainPage bookshelfPage)
	{
        InitializeComponent();
        this.ShelfId = sid;
        MainPageToUpdate = bookshelfPage;
    ...
    public void PopulateShelf()
    {
        ...
        List<Book> updatedShelf = _db.GetBookshelfContents(ShelfId);
        ...
        if (!string.IsNullOrEmpty(BookSearchbar.Text))
        {
            try
            {
                ...
                if (searchResults.Count > 0)
                {
                    ...
                    PopulateShelf();
                    MainPageToUpdate.PopulateBookshelves();
                }
            }
            catch (Exception ex)
    ...
    public void EditBookBtn_Clicked(object sender, EventArgs e)
    {
        if (!ConfirmMenu.IsVisible || !EditMenu.IsVisible)
        {
            ...
            BookToEdit.BookshelfId = book.BookshelfId;
    ...
    public void SaveEditBtn_Clicked(object sender, EventArgs e)
    {
        ...
        updatedBook.BookshelfId = BookToEdit.BookshelfId;
